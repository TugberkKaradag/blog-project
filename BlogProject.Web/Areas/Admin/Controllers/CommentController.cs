    ...
    public class CommentController : Controller
    {
        ...
        public async Task<IActionResult> Create(CreateCommentVM comment)
        {
            if (ModelState.IsValid)
            {
                ...
                Comment comentat = new Comment { AppUser = appUser, AppUserId = comment.AppUserID, Text = comment.Text, Article = article, ArticleId = article.ID };
        ...
        public async Task<IActionResult> List()
        {
            ...
            var commentList = commentRepository.GetByDefaults
                (
                    ...
                    expression: a => a.Statu != Statu.Nothing,
